...
\begin{enumerate}
  ...
  OpenSSL's Big Num \textit{BN_is_prime_fasttest_ex} is used to perform the primality test. It starts by making a trial division by a set of
  small prime numbers and then at least 64 rounds of Miller-Rabin (128 rounds for numbers larger than 2048 bits).
